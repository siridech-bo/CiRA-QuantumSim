...
the $4N_{\rm Fock}$ single-mode density matrix under the full master equation (CPTP-preserving,
$\mathrm{Tr}\,\rho{=}1$, $\rho\succeq0$ asserted); \textsf{ion-ms-mm} generalizes to $M$ modes
...
model). \emph{(E) Cross-validation}: analytic and numerical Bell fidelities agree to
