...
distinct axis; the palindromic waveform makes first-order boundary-timing errors partially
self-cancel, and a dedicated study is readily run in the verifier.
